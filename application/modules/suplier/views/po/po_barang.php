<div class="col-lg-6">
    <label >No PO</label>
    <input type="text"  class="form-control" disabled value="<?=$info_po->no_po;?>">
    <p></p>
    <label for="type_po">Type PO</label>
    <input type="text" class="form-control" disabled value="<?=$info_po->type_po;?>">
    <p></p>
    <label>Tanggal PO</label>
    <input type="text" class="form-control" disabled value="<?=dateme($info_po->date_po);?>">
</div>
<div class="col-lg-6">
    <label >Suplier</label>
    <input type="text" class="form-control" disabled value="<?=$info_po->nama_suplier;?>">
    <p></p>
    <label >No Telpon Suplier</label>
    <input type="text" class="form-control" disabled value="<?=$info_po->no_telpon;?>">
    <p></p>
    <label >Expired</label>
    <input type="text" class="form-control" disabled value="<?=dateme($info_po->date_expired);?>">
</div>
...
<p></p>
    ...
    <div class="col-lg-6">
        ...
        <input type="hidden" name="no_po" value="<?=$info_po->no_po;?>">
    ...
    <div class="col-lg-6">
        ...
        <?php if($receiving_suplier){;?>
            <?php if($receiving_suplier->status_laporan !="Di Terima"){;?>
                <a href="<?=base_url();?>suplier/receiving/receiving_batal/<?=$info_po->no_po;?>" class="btn btn-danger">Batal</a>
            <?php };?>
            <a href="<?=base_url();?>suplier/receiving/receiving_barang/<?=$this->db->get_where('receiving_suplier',['no_po'=>$info_po->no_po])->row_object()->no_receiving;?>" class="btn btn-success">Lihat Receiving</a>
        <?php }else{;?>
