<!-- <?php
    $data = [
        ...
        'title'=>$title,
        'receiving'=>$receiving,
        'receiving_barang'=>$receiving_barang,
        'po_harga'=>$po_harga,
    ];
...
<html>
  ...
  <body>
    <div class="container">
      ...
      <hr>
      <h1>RECEIVING ORDER CHECKER</h1>
    <table id="table_hide">
        <tr>
            <th>No Receiving</th>
            <td>: <?=$receiving->no_receiving;?></td>
            <th>Tanggal Receiving</th>
            <td>: <?=dateme($receiving->date_receiving);?></td>
        </tr>
        <tr>
            <th>No Po</th>
            <td>: <?=$receiving->no_po;?></td>
            <th>Suplier</th>
            <td>: <?=$receiving->nama_suplier;?></td>
        </tr>
        <tr>
            <th>Type Po</th>
            <td>: <?=$receiving->type_po;?></td>
            <th>No Telpon Suplier</th>
            <td>: <?=$receiving->no_telpon;?></td>
        </tr>
        <tr>
            <th>Tanggal Po</th>
            <td>: <?=dateme($receiving->date_po);?></td>
            <th>Tanggal Expired</th>
            <td>: <?=dateme($receiving->date_expired);?></td>
        </tr>
    </table>
      <table>
        <tr>
        ...
        <tr>
          <?php $total_harga = 0; $no = 0;foreach($receiving_barang as $rb):$no+1; $no++;?>
        </tr>
            <td><?=$no;?>.</td>
